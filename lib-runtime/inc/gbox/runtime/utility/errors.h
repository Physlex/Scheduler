...
/** @file `conf/errors.h`
 *  @brief This file defines a set of errors, and implements means to handle
 * them.
 */
 ...
 *
 *         Errors are returned from function calls as negative integers.
 * Specific error codes are designed to be primarily useful to the developer,
 * and not necessarily useful to the application itself.
 *
 *         The design patterns that use these definitions (ex: header guards)
 * are used primarily for public invokations. Private implementations are
 * reccomended to use their own means of error detection and handling.
 *
...
typedef enum error_code {
    ...
    /** @memberof enum error_code
     *  @brief The method has a contract for parameter passing, and the
     * developer broke the contract.
     *
     *         The most common occurance of this is the passing of null pointers
